...
## 1. Schematic Diagram:
The figure below depicts the schematic diagram for LDO using BGR circuit.
![3 Temperature variation of PTAT,CTAT and VREF](https://github.com/abhitejdivi5/Analog-Blocks/blob/main/LDO.png)

## 2. Result:
#### A. Temperature variation of V<sub>REF</sub>
Hence, by adding scaled CTAT and PTAT we obtained a band gap reference of ≈ 1.6V
